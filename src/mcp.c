...
static const char *TOOLS_JSON =
  ...
  "\"description\":\"Grok Build suggestPrompt: predict the next user line. Full auto (default) pair-confirms and enqueues a prompt job. Mesh 0 vetoes. AUGOGEN_AUTO=0 is vote-only.\","
  "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
  "\"transcript\":{\"type\":\"string\"},"
  "\"suggestion\":{\"type\":\"string\",\"description\":\"optional host-supplied line\"}}}},"
  "{\"name\":\"augogen_pending\","
  "\"description\":\"Current augogen plate (pending/approved/rejected/applied). auto_execute follows AUGOGEN_AUTO (default true).\","
  "\"inputSchema\":{\"type\":\"object\",\"properties\":{}}},"
  "{\"name\":\"augogen_vote\","
