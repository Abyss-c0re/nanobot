...
char *ng_memory_system_prompt(void) {
  ...
  if (getenv("GROKIUM_ROOT") || getenv("NANOBOT_CUBE_ALIGN")) {
    asprintf(&out,
      ...
      "Offline develop is fully capable: persist until done. One tool is not done.\n"
      "Complex projects: shell (make, git, test, edit) + CubalC + lattice/project.\n"
      "Tools: grokium_nexus_status, grokium_confess, grokium_cubalc, "
      "grokium_neuralmind, grokium_project, grokium_lattice, grokium_prophecy, "
      "run_terminal_command.\n"
      "On Cube/hive/SoT questions: grokium_nexus_status first.\n"
      "On heresy/doom: grokium_confess.\n"
      "On recall/predict/maintain: grokium_neuralmind.\n"
      "On project/VC: grokium_project. On all-projects SMX: grokium_lattice.\n"
      "You may emit CubalC: [hold] [name] [a~b] [name!] [~n] ? SYS … "
      "or grokium_cubalc (align|develop|prophecy|project|lattice).\n"
